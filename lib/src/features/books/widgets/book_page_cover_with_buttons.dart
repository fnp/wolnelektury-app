...
import 'package:wolnelektury/src/features/books/widgets/book_page_cover_browse_button.dart';
import 'package:wolnelektury/src/features/books/widgets/book_page_cover_favourite_button.dart';
import 'package:wolnelektury/src/features/books/widgets/book_page_cover_listen_button.dart';
import 'package:wolnelektury/src/features/books/widgets/book_page_cover_read_button.dart';
...
class BookPageCoverWithButtons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final showReadButton =
        (buttonTypes == BookButtonType.all ||
            buttonTypes == BookButtonType.offlineReader) &&
        book.children.isEmpty;

    final showListenButton =
        (buttonTypes == BookButtonType.all && book.hasAudiobook ||
            buttonTypes == BookButtonType.offlineAudiobook) &&
        book.children.isEmpty;

    final showBrowseButton = book.children.isNotEmpty;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (showBrowseButton) ...[
                        ...
                        BookPageCoverBrowseButton(book: book),
                      ],
                      if (showReadButton) ...[
                        const SizedBox(height: Dimensions.mediumPadding),
                      ...
                      if (buttonTypes == BookButtonType.all) ...[
                        const SizedBox(height: Dimensions.mediumPadding),
                        BookPageCoverFavouriteButton(book: book),
                      ],
                    ],
                  ),
                ),
