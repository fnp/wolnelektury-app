...
import 'package:wolnelektury/src/features/authors/widgets/author_page_books.dart';
import 'package:wolnelektury/src/features/authors/widgets/author_page_top_bar.dart';
import 'package:wolnelektury/src/features/authors/widgets/author_page_translations.dart';
import 'package:wolnelektury/src/features/common/widgets/button/load_more_button.dart';
      ...
      child: Padding(
        ...
        child: CustomScrollView(
          ...
          slivers: const [
            ...
            SliverToBoxAdapter(child: SizedBox(height: Dimensions.spacer * 2)),
          ],
        ),
      ),
    );
