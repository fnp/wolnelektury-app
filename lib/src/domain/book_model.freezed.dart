...
mixin _$BookModel {
 ...
 String get title; String get url; String get slug; List<EpochModel> get epochs; List<GenreModel> get genres; List<KindModel> get kinds; List<AuthorModel> get authors; List<BookTranslator> get translators; List<BookChild> get children;@JsonKey(name: 'content_warnings') List<String> get contentWarnings; List<String> get audiences;@JsonKey(name: 'elevenreader_link') String? get elevenReaderLink;@JsonKey(name: 'fragment_data') BookFragmentData? get fragment;@JsonKey(name: 'simple_thumb') String? get simpleThumb;@JsonKey(name: 'cover_thumb') String? get coverThumb;@JsonKey(name: 'cover_color') String? get coverColor;@JsonKey(name: 'cover') String? get coverUrl;@JsonKey(name: 'simple_cover') String? get simpleCoverUrl;@JsonKey(name: 'isbn_pdf') String? get isbnPdf;@JsonKey(name: 'isbn_epub') String? get isbnEpub;@JsonKey(name: 'isbn_mobi') String? get isbnMobi;@JsonKey(name: 'abstract') String? get description;@JsonKey(name: 'read_time') int? get readTime;@JsonKey(name: 'has_mp3_file') bool get hasAudiobook;
...
as int?,hasAudiobook: null == hasAudiobook ? _self.hasAudiobook : hasAudiobook // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of BookModel
...
class _BookModel implements BookModel {
  const _BookModel({required this.title, required this.url, required this.slug, final  List<EpochModel> epochs = const [], final  List<GenreModel> genres = const [], final  List<KindModel> kinds = const [], final  List<AuthorModel> authors = const [], final  List<BookTranslator> translators = const [], final  List<BookChild> children = const [], @JsonKey(name: 'content_warnings') final  List<String> contentWarnings = const [], final  List<String> audiences = const [], @JsonKey(name: 'elevenreader_link') this.elevenReaderLink, @JsonKey(name: 'fragment_data') this.fragment, @JsonKey(name: 'simple_thumb') this.simpleThumb, @JsonKey(name: 'cover_thumb') this.coverThumb, @JsonKey(name: 'cover_color') this.coverColor, @JsonKey(name: 'cover') this.coverUrl, @JsonKey(name: 'simple_cover') this.simpleCoverUrl, @JsonKey(name: 'isbn_pdf') this.isbnPdf, @JsonKey(name: 'isbn_epub') this.isbnEpub, @JsonKey(name: 'isbn_mobi') this.isbnMobi, @JsonKey(name: 'abstract') this.description, @JsonKey(name: 'read_time') this.readTime, @JsonKey(name: 'has_mp3_file') this.hasAudiobook = false}): _epochs = epochs,_genres = genres,_kinds = kinds,_authors = authors,_translators = translators,_children = children,_contentWarnings = contentWarnings,_audiences = audiences;
...
@override@JsonKey(name: 'read_time') final  int? readTime;
